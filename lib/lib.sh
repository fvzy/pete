...
# download URLs
export PANEL_DL_URL="https://github.com/pterodactyl/panel/releases/download/v1.10.3/panel.tar.gz"
export WINGS_DL_BASE_URL="https://github.com/pterodactyl/wings/releases/download/v1.7.2/wings_linux_amd64"
export MARIADB_URL="https://downloads.mariadb.com/MariaDB/mariadb_repo_setup"
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/wffzy/pete"}
